...
# For CentOS/RHEL/Rocky Linux
  sudo yum install python3-bcc bcc-tools kernel-devel-$(uname -r)

# OR for Fedora
sudo dnf install python3-bcc bcc-tools kernel-devel-$(uname -r)

# Then install the Python requirements:
  pip install -r requirements.txt

Important: When using a virtual environment with system packages like BCC, you need to create the venv with --system-site-packages:
